...
class Game_Window(object):
                ...
                while True:
                    ...
                    if self.functions.take_turn(self.functions.placement_grid(x,y)) == True and self.functions.isRunning == True:
                        if self.functions.mode == "computer":
                            ...
                            if self.functions.mode == "multiplayer":
                                pass
        ...
        def draw_options(self):
                ...
                if self.functions.mode == "human":
                    option_local_label = font4.render(("Player (local)"), 1, [0,0,0])
                    self.display.blit(option_local_label, (123,265))

                elif self.functions.mode == "multiplayer":
                    option_mp_label = font4.render(("Player (online)"), 1, [0,0,0])
