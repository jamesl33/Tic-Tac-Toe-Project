...
class Game_Window(object):
                ...
                while True:
                        ...
                        if x >= 100 and x <= 300:
                                if y >= 170 and y <= 320:
                                        ...
                                        if self.mode_i == 2:
                                                self.mode_i = 0
                                        self.mode = mode_list[self.mode_i]
                                        self.draw_options()
                        if self.mode == "computer":
                                if x >= 100 and x <= 300:
                                        if y >= 400 and y <= 450:
                                                ...
                                                if self.ai_i == 2:
                                                        self.ai_i = 0
                                                self.ai_diff = ai_list[self.ai_i]
                                                self.draw_options()
                        if x >= 50 and x <= 150:
                                if y >= 500 and y <= 550:
                                        self.main_menu()
        ...
        def draw_options(self):
                ...
                if self.mode == "human":
                        ...
                        if self.ai_diff == "easy":
                                ai_easy_label = font4.render(("Easy"), 1, [0,0,0])
                                self.display.blit(ai_easy_label, (170,410))
                        if self.ai_diff == "hard":
                                ai_hard_label = font4.render(("Hard"), 1, [0,0,0])
                                self.display.blit(ai_hard_label, (170,410))
